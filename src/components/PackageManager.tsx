...
const PackageManager = ({ companyId }: PackageManagerProps) => {
  ...
  const [packageType, setPackageType] = useState<'class_count' | 'time_based'>('class_count');
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Create and manage class packages for your customers</p>
        </div>
      ...
      {showAddPackage && (
        <Card className="mb-6">
          ...
          <CardContent>
            <form onSubmit={handleSubmitPackage} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <Select value={packageType} onValueChange={(value: 'class_count' | 'time_based') => setPackageType(value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="class_count">Fixed Number of Classes</SelectItem>
      ...
      {packages.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-600 mb-4">Create your first class package to start selling bundles.</p>
            <Button onClick={() => setShowAddPackage(true)}>
              <Plus className="w-4 h-4 mr-2" />
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <Badge variant={packageItem.is_active ? "default" : "secondary"}>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="capitalize">{packageItem.package_type.replace('_', ' ')}</span>
                  </div>
