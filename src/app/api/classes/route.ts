...
export async function POST(req: NextRequest) {
  ...
  const { title, class_time, class_date, max_capacity, instructor_uid, organization_uid } = body;
  ...
  return NextResponse.json({ id, organization_uid, instructor_uid, title, class_date, class_time, max_capacity });
}
